document.addEventListener('DOMContentLoaded', function() {
  fetch('../db/instrumentos.json')
      ...
      .then(data => {
          ...
          const instrumentos = data.instrumentos.flauta;
          ...
          if (instrumentos && instrumentos.length > 0) {
              ...
              contenedor.innerHTML = '<p>No se encontraron flautas disponibles.</p>';
          }
      })
      .catch(error => {
          console.error('Error cargando flautas:', error);
          document.getElementById('contenedor-instrumentos').innerHTML = 
              '<p>Error al cargar las flautas. Por favor intente más tarde.</p>';
      });
});